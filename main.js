...
function onClickOpenModal(projectName) {
  ...
  modalContents.innerHTML = `<li class="mx-2 md:mx-8 mt-2 md:mt-4"><img src=${projectDetail[projectName].img} alt=${projectDetail[projectName].img} /></li>`;

  projectDetail[projectName].contents.forEach((v) => {
    modalContents.innerHTML += `<li class="mx-2 md:mx-8 mt-2 md:mt-4 text-xs md:text-base">${v}</li>`;
  });
